...
P\home\Главная страница\P16\Хинт страницы (показывается без линии отводки)
  F\100%x100%\LT\P12\Хинт контейнера
    ...
    B\Перейти на users\RB\140x32\P8\M6\GOTO:users\Хинт кнопки (переход)
...
P\users\Пользователи\Хинт второй страницы
  ...
  B\Назад на home\L\120x32\P8\M6\GOTO:home\Хинт кнопки назад
```
````
...
- `F\100%x80%\T\P12\Подсказка контейнера`
...
- `B\Перейти\RB\140x32\P8\M6\R8\GOTO:users\Открыть страницу users`
